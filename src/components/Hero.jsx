...
const Hero = () => {
  return (
    <section id="home" className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8 ">
      {/* Information */}
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16 text-[5px]">
        <div className="flex flex-col gap-8">
          <h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem]">
            ParkingLocation: Tu Solución Inteligente de {" "}
          ...
          Encuentra, Reserva y Disfruta de Estacionamiento Fácil y Rápido.
          </p>
